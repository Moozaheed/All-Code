...
void Boom()
{
    ...
    for(int i=0;i<3;i++)
    {
        ...
        if(s[0]==s[1]&& s[1]==s[2] && s[0]!='.')str=s[0];
    }
    ...
    for(int i=0;i<3;i++)
    {
        if(arr[0][i]==arr[1][i]&&arr[1][i]==arr[2][i] && arr[0][i]!='.')str=arr[0][i];
    }
  
    if(arr[0][0]==arr[1][1] && arr[1][1]==arr[2][2] && arr[2][2]!='.')str=arr[0][0];
    if(arr[0][2]==arr[1][1] && arr[1][1]==arr[2][0] && arr[2][0]!='.')str=arr[0][2];
